export default {
  ...
  notifyIgnored: 'ignoring a status notification from',
  notifyIgnoredAs: 'as it does not match the device address',
  notifyIgnoredOpt: 'if your network rewrites addresses (docker/nat), enable the Disable Notify Source Check setting',
